...
Connection.prototype.open = function (callback) {
  var self = this;
  // console.log("OPENING CONNECTION: ", self);
  ...
  function errorConnecting (err, destroy) {
    console.log("ERROR CONNECTING TO: ", self.options.host + ':' + self.options.port);
    self.connecting = false;
    if (destroy) {
  ...
  this.netClient.connect(self.options.port, self.options.host, function connectCallback() {
    self.emit('log', 'info', 'Socket connected to ' + self.options.host + ':' + self.options.port);
    console.log("SOCKET CONNECTED TO: ", self.options.host + ':' + self.options.port);
